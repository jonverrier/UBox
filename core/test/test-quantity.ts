...
describe("Quantity", function () {
   ...
   it("Needs to construct correctly", function () {
      let quantity = new QuantityOf<EWeightUnits>(1, EWeightUnits.Kg);
   ...
   it("Needs to compare for equality correctly", function () {
      let quantity1 = new QuantityOf<EWeightUnits>(1, EWeightUnits.Kg);
      let quantity2 = new QuantityOf<EWeightUnits>(2, EWeightUnits.Kg);
      let quantity3 = new QuantityOf<EWeightUnits>(1, EWeightUnits.Kg);
